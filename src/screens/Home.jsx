...
const Home = () => {
  ...
  const getRecipe = async () => {
    const resp = await fetch(
      'https://api.edamam.com/api/recipes/v2?type=public&q=food&app_id=26542a0a&app_key=838f7da80f0a88c3c9c78bd27cc54267',
      {
        method: 'GET',
      },
    );
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <ImageBackground
            ...
            source={require('../assets/food-bg.jpeg')}
          />
          <View style={styles.gradientBlock}>
            <Text style={[styles.headingTxt, {textAlign: 'left'}]}>
              Recipe App
            </Text>
            <TouchableOpacity
              activeOpacity={0.7}
            ...
            <Text style={styles.note}>
              Search yummy recipes with Recipe App
            </Text>
          </View>
        </View>
          ...
          <FlatList
            ...
            renderItem={({item, index}) => (
              <TouchableOpacity
                ...
                />
                <View style={styles.gradientBlock}>
                  <Text style={styles.trendingListTxt}>
                    {item.recipe.label}
                  </Text>
                </View>
              </TouchableOpacity>
